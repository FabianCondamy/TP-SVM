...
On remarque que nous obtenons un score très médiocre d'environ 0,60, ce qui est plus faible qu'auparavant. En effet, la PCA compresse l'information et est donc moins précise. 
En résultat, on a moins d'overfitting, mais également une moins bonne performance.
